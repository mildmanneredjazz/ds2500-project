...
#TODO: focus on race & nutrition/obesity
...
bloop_pressure_df = pd.read_sas('ds2500-project/NHANES_data/BPXO_L.xpt')
body_measures_df = pd.read_sas('ds2500-project/NHANES_data/BMX_L.xpt')

df = demographics_df.merge(dietary_df, on = 'SEQN', how = 'left').merge(cholesterol_df, on = 'SEQN', how = 'left').merge(body_measures_df, on = 'SEQN', how = 'left').merge(bloop_pressure_df, on='SEQN', how='left')
